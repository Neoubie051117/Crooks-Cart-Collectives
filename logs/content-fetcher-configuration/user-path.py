filesToCheck = [
    ...
    "/admin/includes/admin-privacy-policy.php",
    "/admin/includes/admin-terms-and-conditions.php",
    ...
    "/scripts/seller-new-product.js",
    "/scripts/seller-process-order.js",
