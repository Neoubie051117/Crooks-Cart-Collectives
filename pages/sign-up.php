    ...
    <head>
        ...
        <link rel="stylesheet" href="/Barangay-System/styles/sign-up.css">
        <script defer src="/Barangay-System/scripts/sign-up.js"></script>
    ...
    <body>
                ...
                <div class="section">
                    ...
                    <div class="group image-upload">
                        <img id="imageFormalPicturePreview" class="image-preview"
                            src="/Barangay-System/assets/Formal-Picture.png" alt="Upload Formal Picture Preview">
                        <label for="imageFormalPictureUpload">Upload Formal Picture</label>
                        <input type="file" id="imageFormalPictureUpload" name="imageFormalPictureUpload"
                            accept="image/*" required autocomplete="off">
                    </div>

                    <div class="group image-upload">
                        <img id="imageResidencyProofPreview" class="image-preview"
                            src="/Barangay-System/assets/Valid-id-icon.png" alt="Valid ID Preview">
                        <label for="imageResidencyProofUpload">Upload Proof of Residency</label>
                        <input type="file" id="imageResidencyProofUpload" name="imageResidencyProofUpload"
                            accept="image/*" required autocomplete="off">
                    </div>
                </div>
        ...
        <div class="sign-in-link-container">
            <p style="text-align:center; margin-top: 20px;">
                ...
                <a href="/Barangay-System/pages/sign-in.php" class="log-in-colored-link">Log In</a>
            </p>
        </div>
